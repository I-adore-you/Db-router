...
//    private Map<Object, Object> targetDataSources;
    ...
    /*
     Map<masterName, Datasource> targetDataSource / /这里 存着主库 对应的数据源
    Map<masterName,List<Datasource>>  slaveTargetDataSource // 这里存着 masterName 对应着的 从库的 数据源信息

    map 声明的方式 不太一样！
    尽量声明 成线程安全的 concurrentHashMap ， 防止 动态添加数据源的 时候 ，出现 线程安全问题
     */
    protected Map<Object, List<DataSource>> targetSlaveDataSource;
